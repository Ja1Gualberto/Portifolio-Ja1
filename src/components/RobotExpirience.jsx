...
const RobotExpirience = ({ animationName = 'Experiment', ...props }) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/robot_playground.glb')
  const { actions, names } = useAnimations(animations, group)

  useEffect(() => {
    // Toca a animação desejada ou a primeira animação disponível no arquivo GLB
...
export default RobotExpirience;